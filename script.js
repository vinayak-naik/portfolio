...
text[3].onmouseenter = function () { text[3].style.visibility = 'visible'; project[3].style.opacity = '0.4'; }
text[3].onmouseout = function () { text[3].style.visibility = 'visible'; project[3].style.opacity = '0.4'; }
project[3].onmouseenter = function () { text[3].style.visibility = 'visible'; project[3].style.opacity = '0.4'; }
project[3].onmouseout = function () { text[3].style.visibility = 'hidden'; project[3].style.opacity = '1'; }
